    ...
    switch(op) {
        ...
        case 0x13:
            ...
            switch(funct3) {
                ...
                // ADDI
                case 0x0:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = RISCV.gen_reg[((raw >>> 15) & 0x1F)].add(signExtLT32_64(((raw >> 20)), 31));
                    RISCV.pc += 4;
                    break;
                ...
                // SLTI 
                case 0x2:
                    if ((RISCV.gen_reg[((raw >>> 15) & 0x1F)]).lessThan(signExtLT32_64(((raw >> 20)), 31))) {
                ...
                case 0x3:
                    if (long_less_than_unsigned(RISCV.gen_reg[((raw >>> 15) & 0x1F)], signExtLT32_64(((raw >> 20)), 31))) {
                        RISCV.gen_reg[((raw >>> 7) & 0x1F)] = Long.ONE;
                    } else {
                        RISCV.gen_reg[((raw >>> 7) & 0x1F)] = Long.ZERO;
                    }
                ...
                // XORI
                case 0x4:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = (RISCV.gen_reg[((raw >>> 15) & 0x1F)]).xor(signExtLT32_64(((raw >> 20)), 31));
                    RISCV.pc += 4;
                    break;
                ...
                // ORI 
                case 0x6:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = (RISCV.gen_reg[((raw >>> 15) & 0x1F)]).or(signExtLT32_64(((raw >> 20)), 31));
                    RISCV.pc += 4;
                    break;

                // ANDI
                case 0x7:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = (RISCV.gen_reg[((raw >>> 15) & 0x1F)]).and(signExtLT32_64(((raw >> 20)), 31));
                    RISCV.pc += 4;
                    break;
        ...
        case 0x37:
            RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(((raw & 0xFFFFF000)), 31);
            RISCV.pc += 4;
            break;

        // L-TYPE (AUIPC) - opcode: 0b0010111
        case 0x17:
            RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(((raw & 0xFFFFF000)) + (RISCV.pc & 0xFFFFF000), 31);
        ...
        case 0x6F:
            RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(RISCV.pc + 4, 31);
        ...
        case 0x3:
            ...
            switch(funct3) {
                ...
                // LB
                case 0x0:
                    var addr = (RISCV.gen_reg[((raw >>> 15) & 0x1F)]).add(Long.fromNumber(((raw >> 20))|0));
                    var fetch = RISCV.load_byte_from_mem(addr);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(fetch, 7);
                    RISCV.pc += 4;
                    break;
                ...
                case 0x1:
                    ...
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(fetch, 15);
                    RISCV.pc += 4;
                    break;
                ...
                case 0x2:
                    ...
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(fetch, 31);
                    RISCV.pc += 4;
                    break;
        ...
        case 0x23:
            ...
            switch(funct3) {
                ...
                // SB
                case 0x0:
                    var addr = (RISCV.gen_reg[((raw >>> 15) & 0x1F)]).add(Long.fromNumber((((raw >> 20) & 0xFFFFFFE0) | ((raw >>> 7) & 0x0000001F))|0));
...
//                    RISCV.pc += 4;
                ...
                // RDCYCLE
                case 0x6002:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = RISCV.priv_reg[PCR["CSR_CYCLE"]["num"]];
                    RISCV.pc += 4;
                    break;
...
//                                console.log("Value written to FATC is " + stringIntHex(tempbak));
        ...
        case 0x1B:
            ...
            switch(funct3) {
                ...
                // ADDIW
                case 0x0:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64((RISCV.gen_reg[((raw >>> 15) & 0x1F)].getLowBits()|0) + (((raw >> 20))|0), 31);
                    RISCV.pc += 4;
                    break;
                ...
                case 0x1:
                    ...
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(RISCV.gen_reg[((raw >>> 15) & 0x1F)].getLowBits() << (((raw >> 20)) & 0x003F), 31);
                    RISCV.pc += 4;
                    break;
        ...
        case 0x3B:
            ...
            switch(funct10) {
                ...
                // ADDW
                case 0x0:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64((RISCV.gen_reg[((raw >>> 15) & 0x1F)].getLowBits()|0) + (RISCV.gen_reg[((raw >>> 20) & 0x1F)].getLowBits()|0), 31);
                    RISCV.pc += 4;
                    break;
                ...
                // MULW
                case 0x8:
                    RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(RISCV.gen_reg[((raw >>> 15) & 0x1F)].getLowBits()*RISCV.gen_reg[((raw >>> 20) & 0x1F)].getLowBits(), 31);
                    RISCV.pc += 4;
                    break;
                ...
                case 0xC:
                    if (RISCV.gen_reg[((raw >>> 20) & 0x1F)].isZero()) {
                        ...
                        RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64(((RISCV.gen_reg[((raw >>> 15) & 0x1F)].getLowBits()|0)/(RISCV.gen_reg[((raw >>> 20) & 0x1F)].getLowBits()|0))|0, 31);
                    }
                    RISCV.pc += 4;
                    break;
                ...
                case 0xD:
                    if (RISCV.gen_reg[((raw >>> 20) & 0x1F)].isZero()) {
                        ...
                        RISCV.gen_reg[((raw >>> 7) & 0x1F)] = signExtLT32_64((signed_to_unsigned(RISCV.gen_reg[((raw >>> 15) & 0x1F)].getLowBits())/signed_to_unsigned(RISCV.gen_reg[((raw >>> 20) & 0x1F)].getLowBits()))|0, 31);
                    }
                    RISCV.pc += 4;
                    break;
        ...
        case 0x2F:
            ...
            switch(funct8) {
                ...
                // AMOADD.W
                case 0x2:
                    var rd_temp = signExtLT32_64(RISCV.load_word_from_mem(RISCV.gen_reg[((raw >>> 15) & 0x1F)]), 31);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                ...
                case 0x12:
                    ...
                    var fetch = RISCV.load_word_from_mem(RISCV.gen_reg[((raw >>> 15) & 0x1F)]);
                    if (RISCV.excpTrigg) {
                        return;
                    }

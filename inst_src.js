    ...
    switch(op) {
        ...
        case 0x33:
            ...
            switch(funct10) {
                ...
                // SUB
                case 0x100:
                    RISCV.gen_reg_lo[33] = ~RISCV.gen_reg_lo[inst.get_rs2()];
                    RISCV.gen_reg_hi[33] = ~RISCV.gen_reg_hi[inst.get_rs2()];
                    RISCV.gen_reg_lo[32] = 1;
                    RISCV.gen_reg_hi[32] = 0;
                    do_sixty_four_add(33, 32, 32);
                    do_sixty_four_add(inst.get_rs1(), 32, inst.get_rd());
                    RISCV.pc += 4;
                    break;
        ...
        case 0x3:
            ...
            switch(funct3) {
                ...
                case 0x0:
                    ...
                    RISCV.gen_reg_lo[inst.get_rd()] = (fetch << 24) >> 24;
                    RISCV.gen_reg_hi[inst.get_rd()] = (fetch << 24) >> 31;
                    RISCV.pc += 4;
                    break;
                ...
                case 0x1:
                    ...
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    var fetch = RISCV.load_half_from_mem(32);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.gen_reg_lo[inst.get_rd()] = (fetch << 16) >> 16;
                    RISCV.gen_reg_hi[inst.get_rd()] = (fetch << 16) >> 31;
                    RISCV.pc += 4;
                    break;
                ...
                case 0x2:
                    ...
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    var fetch = RISCV.load_word_from_mem_new(32);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                ...
                case 0x3:
                    ...
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    RISCV.load_double_from_mem_new(32, inst.get_rd()); // unlike the others, this fn sets the dest reg directly
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.pc += 4;
                ...
                case 0x4:
                    ...
                    RISCV.gen_reg_lo[inst.get_rd()] = fetch & 0xFF;
                    RISCV.gen_reg_hi[inst.get_rd()] = 0;
                    RISCV.pc += 4;
                    break;
                ...
                case 0x5:
                    ...
                    RISCV.gen_reg_lo[inst.get_rd()] = fetch & 0xFFFF;
                    RISCV.gen_reg_hi[inst.get_rd()] = 0;
                    RISCV.pc += 4;
                    break;
        ...
        case 0x23:
            ...
            switch(funct3) {
                ...
                // SB
                case 0x0:
                    RISCV.gen_reg_lo[32] = inst.get_S_imm()|0;
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    RISCV.store_byte_to_mem(32, RISCV.gen_reg_lo[inst.get_rs2()]);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.pc += 4;
                ...
                case 0x1:
                    ...
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    RISCV.store_half_to_mem(32, RISCV.gen_reg_lo[inst.get_rs2()]);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.pc += 4;
                ...
                case 0x2:
                    ...
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    RISCV.store_word_to_mem_new(32, RISCV.gen_reg_lo[inst.get_rs2()]);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.pc += 4;
                ...
                case 0x3:
                    ...
                    RISCV.gen_reg_hi[32] = RISCV.gen_reg_lo[32] >> 31;
                    do_sixty_four_add(inst.get_rs1(), 32, 32); // reg 32 contains addr
                    RISCV.store_double_to_mem_new(32, RISCV.gen_reg_lo[inst.get_rs2()], RISCV.gen_reg_hi[inst.get_rs2()]);
                    if (RISCV.excpTrigg) {
                        return;
                    }
                    RISCV.pc += 4;
        ...
        case 0x2F:
            ...
            switch(funct8) {
                ...
                case 0x2:
                    ...
                    var temp = rd_t + RISCV.gen_reg_lo[inst.get_rs2()];

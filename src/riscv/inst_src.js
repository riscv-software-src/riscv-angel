function check_HTIF() {
  ...
  if (toHostVal.high_ != 0 || toHostVal.low_ != 0) {
    ...
    var payload = new Long(toHostVal.getLowBits(),
        toHostVal.getHighBits() & 0xFFFF);
    if (device == 0x1) {
      ...
      if (cmd == 0x0) {
        ...
        for (var i = 0; i < toWrite.length; i++) {
          RISCV.memory[(addr.getLowBits() + i) >> 2] &= ~((0xFF) <<
              ((i & 0x3) << 3));
          RISCV.memory[(addr.getLowBits() + i) >> 2] |= (toWrite.charCodeAt(i) &
              0xFF) << ((i & 0x3) << 3);
        }
        // null term if null term would go in new word
        RISCV.memory[(addr.getLowBits() + toWrite.length) >> 2] &= ~((0xFF) <<
            (((addr.getLowBits() + toWrite.length) & 0x3) << 3));

        RISCV.priv_reg[PCR['CSR_FROMHOST']['num']] = Long.ONE;
      } else {
        throw new RISCVError(
            'Other term features not yet implemented ' + stringIntHex(cmd));
      }
    } else if (cmd == 0xFF) {
  ...
  switch (op) {
    ...
    case 0x13:
      ...
      switch (funct3) {
          ...
          // ADDI
        case 0x0:
          RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[inst.get_rs1()].add(
              signExtLT32_64(inst.get_I_imm()));
          RISCV.pc += 4;
          break;

          // SLLI
        case 0x1:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).shiftLeft(
              inst.get_I_imm() & 0x003F);
          RISCV.pc += 4;
          break;

          // SLTI
        case 0x2:
          if ((RISCV.gen_reg[inst.get_rs1()]).lessThan(
              signExtLT32_64(inst.get_I_imm()))) {
        ...
        case 0x3:
          if (long_less_than_unsigned(RISCV.gen_reg[inst.get_rs1()],
              signExtLT32_64(inst.get_I_imm()))) {
            RISCV.gen_reg[inst.get_rd()] = Long.ONE;
          } else {
            RISCV.gen_reg[inst.get_rd()] = Long.ZERO;
          ...
          // XORI
        case 0x4:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).xor(
              signExtLT32_64(inst.get_I_imm()));
          RISCV.pc += 4;
          break;
        ...
        case 0x5:
          ...
          if (aldiff === 0) {
            // SRLI
            RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).shiftRightUnsigned(
                inst.get_I_imm() & 0x003F);
          } else {
            // SRAI
            RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).shiftRight(
                inst.get_I_imm() & 0x003F);
          }
          RISCV.pc += 4;
          break;
          ...
          // ORI
        case 0x6:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).or(
              signExtLT32_64(inst.get_I_imm()));
          RISCV.pc += 4;
          break;
          ...
          // ANDI
        case 0x7:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).and(
              signExtLT32_64(inst.get_I_imm()));
          RISCV.pc += 4;
          break;
    ...
    case 0x33:
      ...
      switch (funct10) {
        ...
        case 0x0:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).add(
              RISCV.gen_reg[inst.get_rs2()]);
          RISCV.pc += 4;
          break;

          // SUB
        case 0x100:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).subtract(
              RISCV.gen_reg[inst.get_rs2()]);
          RISCV.pc += 4;
          break;
        ...
        case 0x1:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).shiftLeft(
              (RISCV.gen_reg[inst.get_rs2()]).getLowBits() & 0x3F);
          RISCV.pc += 4;
          break;
        ...
        case 0x7:
          ...
          // MUL
        case 0x8:
          RISCV.gen_reg[inst.get_rd()] = (RISCV.gen_reg[inst.get_rs1()]).multiply(
              RISCV.gen_reg[inst.get_rs2()]);
          RISCV.pc += 4;
          break;
        ...
        case 0xC:
          ...
          } else if (RISCV.gen_reg[inst.get_rs1()].equals(
              new Long(0x0, 0x80000000)) &&
              RISCV.gen_reg[inst.get_rs1()].equals(
                  new Long(0xFFFFFFFF, 0xFFFFFFFF))) {
            // divide most negative num by -1 -> signed overflow
            // set result to dividend
            RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[inst.get_rs1()];
          } else {
            // actual division
            RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[inst.get_rs1()].div(
                RISCV.gen_reg[inst.get_rs2()]);
          }
          RISCV.pc += 4;
          break;
        ...
        case 0xE:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            // actual rem
            RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[inst.get_rs1()].modulo(
                RISCV.gen_reg[inst.get_rs2()]);
          }
          RISCV.pc += 4;
          break;
    ...
    case 0x17:
      RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(
          inst.get_U_imm() + (RISCV.pc & 0xFFFFF000));
      if ((RISCV.gen_reg[inst.get_rd()].getLowBitsUnsigned() & 0xFF000000) ==
          0x55000000) {
        RISCV.gen_reg[inst.get_rd()] = new Long(
            RISCV.gen_reg[inst.get_rd()].getLowBitsUnsigned(), 0x155);
      }
      RISCV.pc += 4;
      break;
    ...
    case 0x63:
      ...
      switch (funct3) {
          ...
          // BEQ
        case 0x0:
          if ((RISCV.gen_reg[inst.get_rs1()]).equals(
              RISCV.gen_reg[inst.get_rs2()])) {
          ...
          // BNE
        case 0x1:
          if ((RISCV.gen_reg[inst.get_rs1()]).notEquals(
              RISCV.gen_reg[inst.get_rs2()])) {
            RISCV.pc = (RISCV.pc | 0) + inst.get_B_imm();
          } else {
            RISCV.pc += 4;
        ...
        case 0x4:
          ...
          // BGE
        case 0x5:
          if ((RISCV.gen_reg[inst.get_rs1()]).greaterThanOrEqual(
              RISCV.gen_reg[inst.get_rs2()])) {
            RISCV.pc = (RISCV.pc | 0) + inst.get_B_imm();
          } else {
            RISCV.pc += 4;
    ...
    case 0x67:
      ...
      if (funct3 == 0x0) {
        RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(RISCV.pc + 4);
        RISCV.pc = inst.get_I_imm() +
            (RISCV.gen_reg[inst.get_rs1()].getLowBits() | 0);
      } else {
        throw new RISCVTrap('Illegal Instruction');
      }
      break;
    ...
    case 0x3:
      ...
      switch (funct3) {
          ...
          // LB
        case 0x0:
          var addr = (RISCV.gen_reg[inst.get_rs1()]).add(
              Long.fromNumber2(inst.get_I_imm() | 0));
    ...
    case 0x23:
      ...
      switch (funct3) {
        ...
        case 0x0:
          var addr = (RISCV.gen_reg[inst.get_rs1()]).add(
              Long.fromNumber2(inst.get_S_imm() | 0));
          RISCV.store_byte_to_mem(addr,
              RISCV.gen_reg[inst.get_rs2()].getLowBits());
          if (RISCV.excpTrigg) {
            return;
          }
    ...
    case 0x73:
      var superfunct = inst.get_funct3() | inst.get_rs2() << 3 |
          inst.get_funct7() << 8;
      switch (superfunct) {
...
//                    RISCV.pc += 4;
        ...
        case 0x6002:
          RISCV.gen_reg[inst.get_rd()] = new Long(
              RISCV.priv_reg[PCR['CSR_CYCLE']['num']], 0x0);
          RISCV.pc += 4;
          break;
        ...
        case 0x600A:
          ...
          var result = nowtime -
              RISCV.priv_reg[PCR['CSR_TIME']['num']].toNumber();
...
//                                console.log("Value written to FATC is " + stringIntHex(tempbak));
            ...
            case 0x7:
              ...
              if (typeof temp === 'number') {
                ...
                RISCV.gen_reg[inst.get_rd()] = temp;
                temp = temp.and(
                    new Long(inst.get_rs1() & 0x0000001F, 0x0).not());
              }
              RISCV.set_pcr(inst.get_CSR_imm(), temp);
              RISCV.pc += 4;
              // if toHost is written, do stuff:
    ...
    case 0x1B:
      ...
      switch (funct3) {
        ...
        case 0x1:
          ...
          RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(
              RISCV.gen_reg[inst.get_rs1()].getLowBits() <<
              (inst.get_I_imm() & 0x003F));
          RISCV.pc += 4;
          break;
    ...
    case 0x3B:
      ...
      switch (funct10) {
        ...
        case 0x0:
          RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(
              (RISCV.gen_reg[inst.get_rs1()].getLowBits() | 0) +
              (RISCV.gen_reg[inst.get_rs2()].getLowBits() | 0));
          RISCV.pc += 4;
          break;
        ...
        case 0xC:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            RISCV.gen_reg[inst.get_rd()] = new Long(0xFFFFFFFF, 0xFFFFFFFF);
          } else if (RISCV.gen_reg[inst.get_rs1()].getLowBits() == 0xFFFFFFFF &&
              RISCV.gen_reg[inst.get_rs2()].getLowBits() == 0x80000000) {
            // div most negative 32 bit num by -1: result = dividend
            RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[inst.get_rs1()];
          } else {
            RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(
                ((RISCV.gen_reg[inst.get_rs1()].getLowBits() | 0) /
                    (RISCV.gen_reg[inst.get_rs2()].getLowBits() | 0)) | 0);
          }
          RISCV.pc += 4;
          break;
        ...
        case 0xD:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            RISCV.gen_reg[inst.get_rd()] = signExtLT32_64((signed_to_unsigned(
                RISCV.gen_reg[inst.get_rs1()].getLowBits()) /
                signed_to_unsigned(
                    RISCV.gen_reg[inst.get_rs2()].getLowBits())) | 0);
          }
    ...
    case 0x2F:
      ...
      switch (funct8) {
          ...
          // AMOADD.W
        case 0x2:
          var rd_temp = signExtLT32_64(
              RISCV.load_word_from_mem(RISCV.gen_reg[inst.get_rs1()]));
          if (RISCV.excpTrigg) {
            return;
          }

          var temp = rd_temp.add(RISCV.gen_reg[inst.get_rs2()]);
          RISCV.store_word_to_mem(RISCV.gen_reg[inst.get_rs1()],
              temp.getLowBitsUnsigned());
          if (RISCV.excpTrigg) {
            return;
          }
        ...
        case 0xC2:
          ...
          if (signed_to_unsigned(rd_temp.getLowBitsUnsigned()) >
              signed_to_unsigned(
                  RISCV.gen_reg[inst.get_rs2()].getLowBitsUnsigned())) {
            var temp = RISCV.gen_reg[inst.get_rs2()];
          } else {
            var temp = rd_temp;
          }
        ...
        case 0xE2:
          ...
          // AMOADD.D
        case 0x3:
          var rd_temp = RISCV.load_double_from_mem(
              RISCV.gen_reg[inst.get_rs1()]);
          if (RISCV.excpTrigg) {
            return;
          }
        ...
        case 0xC3:
          ...
          if (!long_less_than_unsigned(rd_temp,
              RISCV.gen_reg[inst.get_rs2()])) {
            var temp = RISCV.gen_reg[inst.get_rs2()];
          } else {
            var temp = rd_temp;
        ...
        case 0x1B:
          // this acts just like a sd in this implementation, but it will
          // always set the check register to 0 (indicating load success)
          RISCV.store_double_to_mem(RISCV.gen_reg[inst.get_rs1()],
              RISCV.gen_reg[inst.get_rs2()]);
          if (RISCV.excpTrigg) {
            return;
          }

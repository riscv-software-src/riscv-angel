(function() {
  ...
  setupShepherd = function() {
    ...
    shepherd.addStep('example', {
      ...
      text: ['Hit the "Boot Linux" button to the left to get started!', 'The boot process should take about 25 seconds on <br> a modern system once the kernel image download finishes.', 'You\'ll know that boot is complete when you see a <br> <code>/ #_ </code> &nbsp; prompt preceeding the flashing cursor.', 'This is an <a href="http://en.wikipedia.org/wiki/Almquist_shell">ash-shell</a> prompt where you can type in most<br> standard linux commands included with <a href="http://www.busybox.net">BusyBox</a>.'],
